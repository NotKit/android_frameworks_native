...
public:
    // called in SurfaceFlinger::setUpHWComposer()
    void createHwcValidateData(const DefaultKeyedVector< wp<IBinder>, sp<DisplayDevice> >& displays);

    HwcValidateData& getHwcValidateData();

private:
    HwcValidateData mHwcValidateData;
#endif
};
